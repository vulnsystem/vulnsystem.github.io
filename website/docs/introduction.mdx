...
1. Participants exchange crypto's secp256k1 public keys.
2. Each participant combines their private key with the received public key to derive a shared secret.
