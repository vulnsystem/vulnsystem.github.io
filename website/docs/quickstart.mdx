...
[`Code block`](https://docusaurus.io/docs/markdown-features/code-blocks) and [`Admonitions`](https://docusaurus.io/docs/markdown-features/admonitions) feaures are commonly used.

:::

:::tip[Useful Links]

⚡️ [`website/docusaurus.config.ts`](https://github.com/vulnsystem/vulnsystem.github.io/edit/main/website/docusaurus.config.ts)

⚡️ [`website/sidebars.ts`](https://github.com/vulnsystem/vulnsystem.github.io/edit/main/website/sidebars.ts)

⚡️ [`Actions`](https://github.com/vulnsystem/vulnsystem.github.io/actions)

⚡️ [`website/docs`](https://github.com/vulnsystem/vulnsystem.github.io/tree/main/website/docs)
...
Add this workflow file in [`.github/workflows/deploy.yml`](https://github.com/vulnsystem/vulnsystem.github.io/blob/main/.github/workflows/deploy.yml) derictory:
...
Add or adapt the files in the [`website/docs`](https://github.com/vulnsystem/vulnsystem.github.io/tree/main/website/docs) dir

### Adapte the sidebar {#adpatesidebar}
Adappte the sidebar configration in the [`website/sidebars.ts`](https://github.com/vulnsystem/vulnsystem.github.io/blob/main/website/sidebars.ts) file

### Adapte the navbar optional {#adpatenavbar}
In [`website/docusaurus.config.ts`](https://github.com/vulnsystem/vulnsystem.github.io/blob/main/website/docusaurus.config.ts) file, please adpate the **docId** to make which doc will be loaded default when click the label in the navbar.
...
1. Make sure the current docs version in the [`website/docs`](https://github.com/vulnsystem/vulnsystem.github.io/tree/main/website/docs) is ready to be frozen.
