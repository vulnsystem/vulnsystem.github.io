...
- Copy the full `docs/` folder contents into a new `versioned_docs/version-3.0.1/` folder.
- Create a versioned sidebars file based from your current [sidebar](docs-introduction.mdx#sidebar) configuration (if it exists) - saved as `versioned_sidebars/version-3.0.1-sidebars.json`.
- Append the new version number 3.0.1 to `versions.json`.

:::tip

**[Version is very important conception in the docus](https://vulnsystem.github.io/docs/versionin).**

If you do not know when to create a new version , please read teh [versioning behavior](https://vulnsystem.github.io/docs/versioning#configuring-versioning-behavior). 
